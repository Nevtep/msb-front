...
const Footer = React.forwardRef((props, ref) => (
            <section id="footer" ref={ref}>
                <ul className="icons">
                    ...
                    <li><a href="https://t.me/SOPORTE_MSB" className="icon alt fa-2x fa-telegram"><span className="label">Telegram</span></a></li>
                    <li><a href="https://youtube.com" className="icon alt fa-2x fa-youtube-play"><span className="label">Youtube</span></a></li>
